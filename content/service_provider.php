...
<!-- Start Page Banner -->
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
    										<a data-toggle="collapse" data-parent="#accordion" href="#collapse-5" class="collapsed">
    											<i class="fa fa-angle-up control-icon"></i>
                          <span class=" glyphicon glyphicon-user"></span> John Doe 2
    										</a>
    									</h4>
                    </div>
                    <!-- Toggle Content -->
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
    										<a data-toggle="collapse" data-parent="#accordion" href="#collapse-6" class="collapsed">
    											<i class="fa fa-angle-up control-icon"></i>
                          <span class=" glyphicon glyphicon-user"></span> John Doe 3
    										</a>
    									</h4>
                    </div>
                    <!-- Toggle Content -->
              ...
              <div class = "item">
                <div class="panel-group" id="accordion2">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion2" href="#collapse-7">
                          <i class="fa fa-angle-up control-icon"></i>
                          <span class=" glyphicon glyphicon-user"></span> John Doe 4
                        </a>
                      </h4>
                    </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion2" href="#collapse-8" class="collapsed">
                          <i class="fa fa-angle-up control-icon"></i>
                          <span class=" glyphicon glyphicon-user"></span> John Doe 5
                        </a>
                      </h4>
                    </div>
                    <!-- Toggle Content -->
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion2" href="#collapse-9" class="collapsed">
                          <i class="fa fa-angle-up control-icon"></i>
                          <span class=" glyphicon glyphicon-user"></span> John Doe 3
                        </a>
                      </h4>
          ...
          <div class="col-md-3 sidebar right-sidebar">
            ...
            <div class="widget widget-categories">
              ...
              <ul>
                ...
                <li>
                  <a href="?content=service_provider.php">Service Provider</a>
                </li>
                <li>
                  <a href="?content=subscription_settings.php">Subscription Settings</a>
                </li>
                <li>
                  <a href="?content=testimonials.php">Testimonials</a>
                </li>
                <li>
    ...
    <!-- end modal -->
    <!-- javascripts -->
    <script type="text/javascript" src="js/service_provider.js"></script>